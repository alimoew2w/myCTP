...
################################################################################
class YYTestStrategy(CtaTemplate):
    """ 云扬一号 交易策略 """
    ############################################################################
    ## william
    # 策略类的名称和作者
    name         = 'Yun Yang Test'
    className    = 'YYTestStrategy'
    ...
    def __init__(self, ctaEngine, setting):
        """Constructor"""
        super(YYTestStrategy, self).__init__(ctaEngine, setting)
    ...
    def updateTradingOrders(self, event):
        ...
        if datetime.now().minute % 30 == 0 and datetime.now().second % 59 == 0:
            self.ctaEngine.mainEngine.drEngine.getIndicatorInfo('fl')
        ## =====================================================================
